...
//				new Ascents(new FirstAscend(1955), new FirstAscend(2009), 361)));
       ...
       List<Mountains> mountains = peaksRepo.findByNameEverest();
		...
		List<Mountains> mountains3= peaksRepo.findByEverestAndHeight8848();
		System.out.println(mountains3);
		List<Mountains> mountains4 = peaksRepo.findByEverestOrHeight8848();
		System.out.println(mountains4);
		List<Mountains> mountains5 = peaksRepo.findByLocationChinaAndNepal();
		System.out.println(mountains5);
		List<Mountains> mountains6 = peaksRepo.findByAscentsGreaterThan1000();
		System.out.println(mountains6);
	}
